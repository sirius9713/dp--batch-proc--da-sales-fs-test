...
build_rms_item_loc_hist_dag = DAG(
    dag_id=DAG_ID,
    default_args=args,
    max_active_runs=1,
...
def build_rms_item_loc_hist(ds, **kwargs):
...
build_rms_item_loc_hist = PythonOperator(
    task_id="build_rms_item_loc_hist", python_callable=build_rms_item_loc_hist, provide_context=True, dag=build_rms_item_loc_hist_dag
)

build_rms_item_loc_hist