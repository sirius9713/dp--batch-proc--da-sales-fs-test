...
def build_rms_price_hist(ds, **kwargs):
    ...
    raw_table_name = 'raw_rms_price_hist'
    ods_table_name = 'ods_rms_price_hist'
    table_columns_comma_sep = 'nk, tran_type, reason, event, item, loc, loc_type, unit_cost, unit_retail, selling_unit_retail, selling_uom, action_date, multi_units, multi_unit_retail, multi_selling_uom, post_date, valid_from_dttm, created_dttm, updated_dttm,  is_actual, load_dttm'
    business_key = 'nk'
...
build_rms_price_hist = PythonOperator(
    task_id="build_rms_price_hist", python_callable=build_rms_price_hist, provide_context=True, dag=build_rms_price_hist_dag
)

build_rms_price_hist