...
build_rms_uda_item_date_dag = DAG(
    dag_id=DAG_ID,
    default_args=args,
    max_active_runs=1,
...
def build_rms_uda_item_date(ds, **kwargs):
    ...
    raw_table_name = 'raw_rms_uda_item_date'
    ods_table_name = 'ods_rms_uda_item_date'
    table_columns_comma_sep = 'nk,item,uda_id,uda_date, create_datetime, last_update_datetime, last_update_id, valid_from_dttm, created_dttm, updated_dttm,is_actual, load_dttm'
...
build_rms_uda_item_date = PythonOperator(
    task_id="build_rms_uda_item_date", python_callable=build_rms_uda_item_date, provide_context=True, dag=build_rms_uda_item_date_dag
)

build_rms_uda_item_date