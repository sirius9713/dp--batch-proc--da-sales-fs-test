...
def build_rms_uda_values(ds, **kwargs):
    ...
    raw_table_name = 'raw_rms_uda_val'
    ods_table_name = 'ods_rms_uda_values'
    table_columns_comma_sep = 'nk,uda_id,uda_value,uda_value_desc, valid_from_dttm, created_dttm, updated_dttm,is_actual, load_dttm'
    business_key = 'nk'
...
build_rms_uda_values = PythonOperator(
    task_id="build_rms_uda_values", python_callable=build_rms_uda_values, provide_context=True, dag=build_rms_uda_values_dag
)

build_rms_uda_values