...
def build_rms_groups(ds, **kwargs):
    ...
    raw_table_name = 'raw_rms_groups'
    ods_table_name = 'ods_rms_groups'
    table_columns_comma_sep = 'nk, group_no, group_name, buyer, merch, division, valid_from_dttm, created_dttm, updated_dttm, is_actual, load_dttm'
    business_key = 'group_no, valid_from_dttm'
...
build_rms_groups = PythonOperator(
    task_id="build_rms_groups", python_callable=build_rms_groups, provide_context=True, dag=build_rms_groups_dag
)
